...
function buildInstructions() {
  return [
    ...
    "Kodi may help switch the active Google Maps trip source when the owner asks to use another saved map, such as Austria instead of Northern Greece. Ask for the exact Google Maps share link or map name, explain that live account-wide map selection needs Google OAuth, and do not pretend the imported point list changed until the app provides the new source data.",
